...
import { Badge, Button, FileInput, Notification, Switch, TagsInput, Textarea, TextInput } from '@mantine/core';
    ...
    const savePost = async () => {
        ...
        try {
            ...
            await new Promise((resolve, reject) => {
                setTimeout(() => {
                    if (title && description && image && editorContent.content && editorContent.content.length > 1) {
                        resolve(newPost);
                    } else {
            ...
            showNotification('error', error instanceof Error ? error.message : 'Something went wrong. Try again');
    ...
    return (
        <div className={classes.container}>
            ...
            {notification.show && notification.type === 'error' && (
                <Notification icon={<IconX size={20} />} mt="md" color="red" title="Error" onClose={hideNotification}>
